...
/** The money rule lives in its own leaf module so the /wiki client bundle can
 *  import it without this barrel's trace/span/search helpers. */
export { fmtCost } from "./fmt-cost.ts";
