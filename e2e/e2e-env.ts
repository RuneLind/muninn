 ...
 *
 *   2. INSTANCE-PROFILE FLAGS — `MUNINN_WIKI_READONLY`, `SYNC_REPOS`, the
 *      `MUNINN_AUTH` family and the two `CLAUDE_USAGE_*` endpoints. These say
 *      WHICH INSTANCE this is, so inheriting them makes the suite host-dependent: on the Mac mini,
